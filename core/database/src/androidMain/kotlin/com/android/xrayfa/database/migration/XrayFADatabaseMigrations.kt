...
val MIGRATION_4_5 = object : Migration(4, 5) {
    override fun migrate(db: SupportSQLiteDatabase) {
        db.execSQL("CREATE INDEX IF NOT EXISTS index_Node_subscriptionId ON Node(subscriptionId)")
        db.execSQL("CREATE INDEX IF NOT EXISTS index_Node_favorite ON Node(favorite)")
        db.execSQL("CREATE INDEX IF NOT EXISTS index_Node_selected ON Node(selected)")
    }
}
